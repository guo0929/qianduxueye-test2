...
export default {
    ...
    methods:{
        ...
        list(page){
            Loading.show();
            let _this = this;
            let url = "http://localhost:9002/business/admin/teacher/list";
            _this.$ajax.get(url,{
       ...
       save(){
           ...
           if (1 != 1
            ...
            Loading.show();
            let url = "http://localhost:9002/business/admin/teacher/save";
        ...
        del(id){
            ...
            Confirm.show("删除后不可恢复,请三思而后行",function(){
                Loading.show();
                let url = "http://localhost:9002/business/admin/teacher/delete/";
        ...
        afterUpload(data){
            let _this = this;
            _this.teacher.image = data.content.key;
            _this.$forceUpdate();
